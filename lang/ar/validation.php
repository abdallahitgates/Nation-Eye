...
return [
    ...
    'custom' => [
        'file' => [
            ...
            'file' => 'يجب أن يكون الملف صالحًا.',
            'mimes' => 'الملف يجب أن يكون من نوع: :values.',
            'mimetypes' => 'الملف يجب أن يكون من نوع: :values.',
            'max' => 'الملف يجب ألا يتجاوز الحجم :max كيلوبايت.',
            'min' => 'الملف يجب أن لا يقل عن الحجم :min كيلوبايت.',
        ],
    ],
    'attributes' => [
        'file' => 'الملف',
